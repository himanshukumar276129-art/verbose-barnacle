"""
FastAPI Application - VedaApex Space Image Backend
Multi-provider search with NASA, Wikimedia Commons, and Pexels
"""
...
app = FastAPI(
    ...
    description="Multi-provider image and video search: NASA, Wikimedia Commons, Pexels",
